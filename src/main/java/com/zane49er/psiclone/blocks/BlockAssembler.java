...
public class BlockAssembler extends BlockBase implements ITileEntityProvider {
	...
	public BlockAssembler(String name) {
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ModBlocks.ASSEMBLER);
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		if (!worldIn.isRemote) {
			playerIn.openGui(Main.instance, Reference.GUI_ASSEMBLER, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
		return true;
	}
	
	//see part one for setState class
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		...
		TileEntityAssembler tileentity = (TileEntityAssembler)worldIn.getTileEntity(pos);
